...
cp training/scene204/dataset/scene204.py \
   /workspace/WildScenes/wildscenes/mmseg_wildscenes/dataset/scene204.py
...
echo "from wildscenes.mmseg_wildscenes.dataset.scene204 import Scene204Dataset, SCENE204_LABEL_MAP" \
   >> /workspace/WildScenes/wildscenes/mmseg_wildscenes/__init__.py
```
...
cp training/scene204/mmseg_configs/_base_dataset_scene204.py \
   /workspace/WildScenes/wildscenes/configs/_base_/datasets/scene204.py

cp training/scene204/mmseg_configs/train_finetune.py \
   /workspace/WildScenes/wildscenes/configs/deeplabv3/deeplabv3_r50-d8_2xb4-5k_scene204-512x512.py
```
...
cp training/scene204/mmseg_configs/train_scratch.py \
   /workspace/WildScenes/wildscenes/configs/deeplabv3/deeplabv3_r50-d8_50k_scene204-scratch-512x512.py
