...
# ── 数据路径（容器内路径） ────────────────────────────────────────────────────
GOOSE_VAL_ROOT = "/root/distance/WildScenes/DISTANCE/datasets/Goose/goose_2d_val"
IMG_GLOB       = os.path.join(GOOSE_VAL_ROOT, "images/val/**/*_windshield_vis.png")
LBL_ROOT       = os.path.join(GOOSE_VAL_ROOT, "labels/val")
OUT_BASE       = "/root/distance/WildScenes/vis_output"  # 输出目录 /root/distance/WildScenes/vis_output
