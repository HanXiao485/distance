...
用法:
    python audit_labels.py \
        --img-dir /root/distance/WildScenes/DISTANCE/datasets/processed/goose2d/train/image \
        --lbl-dir /root/distance/WildScenes/DISTANCE/datasets/processed/goose2d/train/indexLabel
"""
import argparse
import glob
import os
