# DDRNet-23-slim on GOOSE 2D (12 categories), mmsegmentation.
# 复用 GOOSE category 数据集配置 + 标准 80k 训练计划。
_base_ = [
    '../_base_/datasets/goose_category.py',
    '../_base_/default_runtime.py',
    '../_base_/schedules/schedule_80k.py',
]

crop_size = _base_.crop_size     # (512, 512)
num_classes = _base_.num_classes # 12
