...
# 从头训练 — 无 load_from，backbone 用 ImageNet 预训练
# max_iters=5000 只是踩坑用，生产环境换 50000+
...
param_scheduler = [
    dict(type='PolyLR', eta_min=1e-5, power=0.9, begin=0, end=5000, by_epoch=False)
]

work_dir = '../work_dirs/scene204_deeplabv3_scratch_test'
