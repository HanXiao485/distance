...
用法:
    python run_e2e_pipeline.py \
        --engine /workspace/WildScenes/trt_engines/deeplabv3_wildscenes_fp16.trt \
        --model-config wildscenes/configs/deeplabv3/deeplabv3_r50-d8_2xb20-80k_wildscenes-512x512_standard.py \
        --num-classes 15 \
        --traversable-class 1 \
        --gt-class-id 2 \
        --dataset-root /root/distance/WildScenes/DISTANCE/datasets/wildscenes_mini \
        --distance-root /workspace/WildScenes/DISTANCE \
        --output-root /root/distance/WildScenes/DISTANCE/outputs/wildscenes_mini_trt_deeplabv3 \
        --tag deeplabv3_trt
"""
import argparse
import glob
